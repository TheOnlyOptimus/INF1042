...
# Current virtual resolution (what your game is designed for)
WIDTH, HEIGHT = 1280, 720
LEVEL_W, LEVEL_H = 11000, 900

# Fullscreen settings
FULLSCREEN = False          # Change to True for default fullscreen
ASPECT_RATIO = WIDTH / HEIGHT  # world size in pixels

BG_COLOR  = (18, 18, 24)
PLAT_COL  = (60, 60, 70)

SPRITE_SCALE  = 4
PLAYER_WIDTH  = 128 * SPRITE_SCALE   # 512 px on screen
PLAYER_HEIGHT = 128 * SPRITE_SCALE   # 512 px on screen
...
ANIM_MANIFEST = {
    ...
    State.RESTING:       ("Idle_2",          5),      
     State.STAND_UP:      ("Idle_2",         5),
}
